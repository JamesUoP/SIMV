...
image_path   = "./IMAGES/BusTest.jpg"
video_path   = "./IMAGES/test.mp4"

yolo = Load_Yolo_model()
label, imageguff = detect_image(yolo, image_path, "./IMAGES/BusTestPred.jpg", input_size=YOLO_INPUT_SIZE, show=True, CLASSES=TRAIN_CLASSES, rectangle_colors=(255,0,0))
print(label)
