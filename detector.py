...
#from controller import video_feed
...
video_feed = '4ktestvid_Trim10sec.mp4'
# video_feed = sys.argv[1:]
...
def main():
    ...
    while True:
        ...
        for (i, c) in enumerate(contours):
            ...
            for (x, y) in detect:
                ...
                if ((pos_line + offset) > y > (pos_line - offset)) and (line_left < x < line_right):
                    previous_frame, previous_x, detect, cars = detection(detect, cars, frame, x, y, w, h, previous_frame, previous_x)
                    print(str(detect))
        ...
        cv2.imshow('Detector Windows: 1', stacked)
...
def detection(detect, car_count, frame, x, y, w, h, previous_frame, previous_x):
